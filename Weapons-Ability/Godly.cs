...
public class GoliathDoomship : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        ...
        var wpn2 = Game.instance.model.GetTowerFromId("MonkeyAce-Paragon").GetBehaviors<AttackAirUnitModel>()[1]
            .Duplicate();
        var wpn3 = Game.instance.model.GetTowerFromId("MonkeyAce-Paragon").GetBehaviors<AttackAirUnitModel>()[2]
            .Duplicate();
        var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
        ace.AddBehavior(wpn);
...
public class ArcaneGuardian : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        ...
        wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 6, 0, false, false)
            { name = "MoabModifier_" });
...
public class Godly
{
    public static List<string> GodlyWpn = new();
    public static List<string> GodlyImg = new();
    public static List<Sprite> GodlyCustomImg = new();
}