...
public class Exotic
{
    public static List<string> ExoticWpn = new();
    public static List<string> ExoticImg = new();
    public static List<Sprite> ExoticCustomImg = new();
    ...
    public class SuperStorm : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var tornado = Game.instance.model.GetTowerFromId("Druid-520").GetAttackModel().weapons
                .First(w => w.name.Contains("Superstorm")).Duplicate();
            var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
    ...
    public class FlyingFortress : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            var wpn2 = Game.instance.model.GetTowerFromId("MonkeyAce-205").GetBehaviors<AttackAirUnitModel>()[1]
                .Duplicate();
            var wpn3 = Game.instance.model.GetTowerFromId("MonkeyAce-205").GetBehaviors<AttackAirUnitModel>()[2]
                .Duplicate();
            var wpn4 = Game.instance.model.GetTowerFromId("MonkeyAce-205").GetBehaviors<AttackAirUnitModel>()[3]
                .Duplicate();
            var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
            ace.AddBehavior(wpn);
    ...
    public class ExplosionKing : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            firework.AddBehavior(new CreateProjectileOnExpireModel("Explosion", clusterExplosion,
                new ArcEmissionModel("FragmentEmmision_", 1, 0, 0, null, true, false), false));
            recursiveFirework.AddBehavior(new CreateProjectileOnExpireModel("Explosion", recursiveExplosion,
                new ArcEmissionModel("FragmentEmmision_", 1, 0, 0, null, true, false), false));

            firework.AddBehavior(new CreateProjectileOnExpireModel("Firework", recursiveFirework,
    ...
    public class PolarVortex : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.weapons[0].projectile.AddBehavior(new FreezeModel("FreezeModel_", 0, 1f, "ShardFreeze", 1, "Ice", true,
            ...
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnContactModel("CreateProjectileOnContactModel_",
                shard, new ArcEmissionModel("ArcEmissionModel_", 5, 0, 50, null, true, false), true, false, false));
            wpn.weapons[0].projectile.AddBehavior(Game.instance.model.GetTowerFromId("NinjaMonkey-020").GetAttackModel()
                .weapons[0].projectile.GetBehavior<RemoveBloonModifiersModel>().Duplicate());
            wpn.range = tower.towerModel.range;

            var breath = Game.instance.model.GetTower(TowerType.DartMonkey).GetAttackModel().Duplicate();
            breath.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.IceMonkey, 0, 0, 3)
                .GetAttackModel().weapons[0].projectile.display;
            ...
            breath.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 3, 5, false, false)
                { name = "MoabModifier_" });

            breath.weapons[0].projectile.AddBehavior(new FreezeModel("FreezeModel_", 0, 1f, "BreathFreeze", 999999,
                "Ice", true, new GrowBlockModel("GrowBlockModel_"), null, 0, false, false));
            breath.weapons[0].projectile.collisionPasses = new[] { 0, -1 };
            ...
            var icicleOrbit = Game.instance.model.GetTower(TowerType.BoomerangMonkey, 5).GetBehavior<OrbitModel>()
                .Duplicate();
            icicleOrbit.projectile.display = Game.instance.model.GetTower(TowerType.IceMonkey, 0, 0, 5).GetAttackModel()
                .weapons[0].projectile.display;
            ...
            icicleDamage.weapons[0].projectile
                .AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 2, 0, false, false)
                    { name = "MoabModifier_" });
            icicleDamage.weapons[0].projectile.AddBehavior(new FreezeModel("FreezeModel_", 0, 1f, "ShardFreeze", 1,
                "Ice", true, new GrowBlockModel("GrowBlockModel_"), null, 0, false, false));
            icicleDamage.weapons[0].projectile.collisionPasses = new[] { 0, -1 };
    ...
    public class KingCobra : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var overlay = Game.instance.model.GetTowerFromId("GlueGunner-300").GetAttackModel().weapons[0].projectile
                .GetBehavior<SlowModel>().overlayType;
            ...
            var wpn = Game.instance.model.GetTowerFromId("DartMonkey-002").GetAttackModel().Duplicate();
            wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
            wpn.weapons[0].rate = Game.instance.model.GetTower(TowerType.GlueGunner).GetAttackModel().weapons[0].rate /
                                  7f;
            wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.GlueGunner, 3).GetAttackModel()
                .weapons[0].projectile.display;
            ...
            wpn.weapons[0].projectile.AddBehavior(Game.instance.model.GetTowerFromId("GlueGunner-100").GetAttackModel()
                .weapons[0].projectile.GetBehavior<CreateSoundOnProjectileCollisionModel>().Duplicate());
            wpn.weapons[0].projectile.AddBehavior(slowModel);
            wpn.weapons[0].projectile.hasDamageModifiers = true;
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 3, 0, false, false)
                { name = "MoabModifier_" });
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Fortified", 2, 0, false, false)
    ...
    public class FlyingDutchman : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            var orbit = Game.instance.model.GetTower(TowerType.BoomerangMonkey, 5).GetBehavior<OrbitModel>()
                .Duplicate();
            orbit.projectile.ApplyDisplay<T4SouldOrb>();
            orbit.range = aura.range;
            orbit.count = 10;

            var necro = Game.instance.model.GetTower(TowerType.WizardMonkey, 0, 0, 5)
                .GetBehavior<NecromancerZoneModel>().Duplicate();
            var necroWeapon = Game.instance.model.GetTower(TowerType.WizardMonkey, 0, 0, 5).GetAttackModel(2)
                .Duplicate();
    ...
    public class Incinerator : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
            wpn.weapons[0].projectile.AddBehavior(new WindModel("WindModel_", 18, 36, 100, false, null, 0, null));
            ...
            wpn.weapons[0].projectile.GetBehavior<TravelStraitModel>().Lifespan = Game.instance.model
                .GetTower(TowerType.DartMonkey).GetAttackModel().weapons[0].projectile.GetBehavior<TravelStraitModel>()
                .Lifespan * 1.2f;
            wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
            wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.WizardMonkey, 0, 1)
                .GetAttackModel(1).weapons[0].projectile.display;
            wpn.weapons[0].projectile.AddBehavior(fire);
            wpn.weapons[0].projectile.collisionPasses = new[] { -1, 0, 1 };
            wpn.weapons[0].projectile.hasDamageModifiers = true;
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 2, 0, false, false)
                { name = "MoabModifier_" });
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "BAD", 3, 0, false, false)
                { name = "BADModifier_" });
            towerModel.AddBehavior(wpn);
            tower.UpdateRootModel(towerModel);
        }
    ...
    public class MasterWaves : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.BeastHandler, 2)
                .GetBehavior<BeastHandlerLeashModel>().towerModel.GetAttackModel().weapons[0].projectile.display;
            ...
            var orca = Game.instance.model.GetTower(TowerType.BeastHandler, 4).GetBehavior<BeastHandlerLeashModel>()
    ...
    public class Lockdown : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.weapons[0].projectile.AddBehavior(new WindModel("WindModel_", 0, 45, 75, true, null, 0, null));
            wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
    ...
    public class PrimalLegend : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.weapons[0].projectile.hasDamageModifiers = true;
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 1, 56, false, false)
                { name = "MoabModifier_" });
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Ceramic", 1, 16, false, false)
                { name = "CeramicModifier_" });

            wpn.weapons[0].projectile.collisionPasses = new[] { 0, -1 };
            wpn.weapons[0].projectile.AddBehavior(new FreezeModel("FreezeModel_", 0, 2.5f, "Stun", 999, "Stun", true,
                new GrowBlockModel("GrowBlockModel_"), null, 0, false, true));

            var shard = Game.instance.model.GetTower(TowerType.TackShooter).GetAttackModel().weapons[0].projectile
                .Duplicate();
            ...
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnContactModel("", shard,
                new ArcEmissionModel("aaa", 16, 0, 360, null, true, false), true, false, false));
            wpn.range = tower.towerModel.range;
            towerModel.AddBehavior(wpn);
            tower.UpdateRootModel(towerModel);
        }
