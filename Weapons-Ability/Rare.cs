...
public class HeartOfThunder : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        var wpn = Game.instance.model.GetTowerFromId("Druid-200").GetAttackModel().weapons
            .First(w => w.name == "WeaponModel_Lightning").Duplicate();
        var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
...
public class Frostbite : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        ...
        wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.IceMonkey, 0, 0, 5).GetAttackModel()
...
public class CrackShotDarts : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        ...
        wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnContactModel("Crackshot", dart,
            new ArcEmissionModel("ArcEmissionModel_", 3, 0, 25, null, true, false), true, false, false));
        var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
        ace.AddBehavior(wpn);
        phoenix.towerModel.ApplyDisplay<BlankDisplay>();
        phoenix.towerModel.RemoveBehavior<AttackModel>();
...
public class SaiToss : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        ...
        wpn.weapons[0].rate =
            Game.instance.model.GetTowerFromId("NinjaMonkey-200").GetAttackModel().weapons[0].rate * 3f;
...
public class BananaStock : WeaponTemplate
{
    ...
    {
        var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
        var cash = Game.instance.model.GetTower(TowerType.BananaFarm, 0, 0, 5)
...
public class BurstFire : WeaponTemplate
{
    ...
    public override void EditTower(Tower tower)
    {
        ...
        wpn.weapons[0].projectile.hasDamageModifiers = true;
        wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Ceramic", 1, 3, false, false)
...
public class Rare
{
    public static List<string> RareWpn = new();
    public static List<string> RareImg = new();
    public static List<Sprite> RareCustomImg = new();
}