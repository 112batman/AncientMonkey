...
namespace AncientMonkey.Weapons
{
    public class Bloonarius : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            var agemodel = Game.instance.model.GetTowerFromId("SpikeFactory").GetAttackModel().weapons[0].projectile
                .GetBehavior<AgeModel>().Duplicate();
            ...
            summon.weapons[0].emission = new NecromancerEmissionModel("Bloonarius.", 99999999, 999999, 1, 1, 1, 50, 0,
                null, null, null, 1, 100, 1, 1, 2);
            ...
            summon2.weapons[0].emission = new NecromancerEmissionModel("Bloonarius.", 99999999, 999999, 5, 10, 1, 75, 0,
                null, null, null, 1, 100, 1, 1, 2);
            ...
            summon3.weapons[0].emission = new NecromancerEmissionModel("Bloonarius.", 99999999, 999999, 25, 50, 1, 75,
                0, null, null, null, 1, 100, 1, 1, 2);
    ...
    public class Lych : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            lych.weapons[0].projectile.ApplyDisplay<BlankDisplay>();
            lych.GetDescendant<RotateToTargetModel>().rotateTower = false;
            lych.weapons[0].projectile.AddBehavior(new CreateTowerModel("LychTower",
                GetTowerModel<LychMinion>().Duplicate(), 0f, true, false, false, true, true));
    ...
    public class Vortex : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            var stuntag = Game.instance.model.GetTowerFromId("BombShooter-400").GetDescendant<SlowModifierForTagModel>()
                .Duplicate();
            ...
            var explosion = Game.instance.model.GetTower(TowerType.MortarMonkey, 5)
                .GetDescendant<CreateEffectOnExpireModel>().Duplicate();
            vort.weapons[0].projectile.AddBehavior(explosion);

            var superbrittle = Game.instance.model.GetTowerFromId("IceMonkey-500")
                .GetDescendant<AddBonusDamagePerHitToBloonModel>();
    ...
    public class Phayze : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            orbit.range = 50;
            var orbitDamage = Game.instance.model.GetTower(TowerType.BoomerangMonkey, 5)
                .GetAttackModel("AttackModel_OrbitAttack_").Duplicate();
    ...
    public class Omega
    {
        public static List<string> OmegaWpn = new();
        public static List<string> OmegaImg = new();
        public static List<Sprite> OmegaCustomImg = new();
    }
}
