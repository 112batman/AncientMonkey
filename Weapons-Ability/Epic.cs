...
namespace AncientMonkey.Weapons
{
    public class Epic
    {
        public static List<string> EpicWpn = new();
        public static List<string> EpicImg = new();
        public static List<Sprite> EpicCustomImg = new();
        ...
        public class OperationDartStorm : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                var phoenix = Game.instance.model.GetTowerFromId("WizardMonkey-050")
                    .GetBehavior<TowerCreateTowerModel>().Duplicate();
                var ace = Game.instance.model.GetTowerFromId("MonkeyAce-420").GetBehavior<AirUnitModel>().Duplicate();
                var wpn = Game.instance.model.GetTowerFromId("MonkeyAce-420").GetBehavior<AttackAirUnitModel>()
                    .Duplicate();
                var wpn2 = Game.instance.model.GetTowerFromId("MonkeyAce-420").GetBehaviors<AttackAirUnitModel>()[1]
                    .Duplicate();
                var wpn3 = Game.instance.model.GetTowerFromId("MonkeyAce-420").GetBehaviors<AttackAirUnitModel>()[2]
                    .Duplicate();
                var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
                ace.AddBehavior(wpn);
        ...
        public class FavoredTrades : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                var wpn = Game.instance.model.GetTowerFromId("MonkeyBuccaneer-004")
        ...
        public class Rifleman : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                wpn.weapons[0].projectile
                    .AddBehavior(new DamageModifierForTagModel("aaa", "Ceramic", 1, 3, false, false)
        ...
        public class PlasmaBomb : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                charge.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 1, 20, false, false)
                    { name = "MoabModifier_" });
                ...
                wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.AddBehavior(
                    new DamageModifierForTagModel("aaa", "Fortified", 1, 3, false, false)
                        { name = "FortifiedModifier_" });
                wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.AddBehavior(
                    new DamageModifierForTagModel("aaa", "Moabs", 1, 20, false, false) { name = "MoabModifier_" });
        ...
        public class FireCracker : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                var explosion = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0]
                    .projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.Duplicate();
                var bombEffect = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0]
                    .projectile.GetBehavior<CreateEffectOnContactModel>().effectModel.Duplicate();
                var fragment = Game.instance.model.GetTower(TowerType.TackShooter).GetAttackModel().weapons[0]
                ...
                wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExpireModel("Fragment", fragment,
                    new ArcEmissionModel("FragmentEmmision_", 6, 0, 360, null, true, false), false));
        ...
        public class IceMagic : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                var shard = Game.instance.model.GetTower(TowerType.DartMonkey).GetAttackModel().weapons[0].projectile
                    .Duplicate();
                shard.display = Game.instance.model.GetTower(TowerType.IceMonkey, 0, 0, 5).GetAttackModel().weapons[0]
                    .projectile.display;
                shard.scale /= 1.25f;
                shard.pierce += 2;
                ...
                shard.AddBehavior(Game.instance.model.GetTowerFromId("NinjaMonkey-020").GetAttackModel().weapons[0]
                    .projectile.GetBehavior<RemoveBloonModifiersModel>().Duplicate());

                var wpn = Game.instance.model.GetTowerFromId("DartMonkey-002").GetAttackModel().Duplicate();
                wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.IceMonkey, 0, 0, 5)
                ...
                wpn.weapons[0].projectile.AddBehavior(new FreezeModel("FreezeModel_", 0, 1f, "ShardFreeze", 1, "Ice",
                    true, new GrowBlockModel("GrowBlockModel_"), null, 0, false, false));
                wpn.weapons[0].projectile.collisionPasses = new[] { 0, -1 };
                wpn.weapons[0].projectile.pierce = 1;
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnContactModel(
                    "CreateProjectileOnContactModel_", shard,
                    new ArcEmissionModel("ArcEmissionModel_", 3, 0, 30, null, true, false), true, false, false));
                wpn.weapons[0].projectile.AddBehavior(Game.instance.model.GetTowerFromId("NinjaMonkey-020")
                    .GetAttackModel().weapons[0].projectile.GetBehavior<RemoveBloonModifiersModel>().Duplicate());
                wpn.range = tower.towerModel.range;
                var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
                towerModel.AddBehavior(wpn);
                tower.UpdateRootModel(towerModel);
        ...
        public class AciGunner : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                var overlay = Game.instance.model.GetTowerFromId("GlueGunner-300").GetAttackModel().weapons[0]
                    .projectile.GetBehavior<SlowModel>().overlayType;
                var slow = Game.instance.model.GetTowerFromId("GlueGunner-100").GetAttackModel().weapons[0].projectile
                    .GetBehavior<SlowModel>().Duplicate();
                var slowModel = new SlowModel("SlowModel_", slow.multiplier, slow.lifespan, "AcidSlow", 3, overlay,
                    slow.isUnique, slow.dontRefreshDuration, slow.effectModel, true, false, false);

                var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
                var wpn = Game.instance.model.GetTowerFromId("DartMonkey-002").GetAttackModel().Duplicate();
                wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
                wpn.weapons[0].rate =
                    Game.instance.model.GetTower(TowerType.GlueGunner).GetAttackModel().weapons[0].rate / 2.8f;
                wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.GlueGunner, 3)
                    .GetAttackModel().weapons[0].projectile.display;
                ...
                wpn.weapons[0].projectile.AddBehavior(Game.instance.model.GetTowerFromId("GlueGunner-100")
                    .GetAttackModel().weapons[0].projectile.GetBehavior<CreateSoundOnProjectileCollisionModel>()
                    .Duplicate());
                wpn.weapons[0].projectile.AddBehavior(slowModel);
                wpn.GetBehavior<AttackFilterModel>().filters = Game.instance.model.GetTowerFromId("DartMonkey-003")
                    .GetAttackModel().GetBehavior<AttackFilterModel>().filters;
                wpn.range = tower.towerModel.range;
                towerModel.AddBehavior(wpn);
                tower.UpdateRootModel(towerModel);
            }
        ...
        public class FlakGun : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                var bomb = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0].projectile
                    .Duplicate();
                ...
                var shrapnel = Game.instance.model.GetTower(TowerType.TackShooter).GetAttackModel().weapons[0]
                    .projectile.Duplicate();
                shrapnel.pierce = 3;
                ...
                var contactModel = new CreateProjectileOnContactModel("aaa", blast,
                        new ArcEmissionModel("ArcEmissionModel_", 1, 0, 0, null, false, false), true, false, false)
                    { name = "RifleBlast_" };
                var fragmentModel = new CreateProjectileOnContactModel("aaa", shrapnel,
                        new ArcEmissionModel("ArcEmissionModel_", 6, 0, 360, null, true, false), true, false, false)
                    { name = "RifleShrapnel_" };
        ...
        public class AssaultSub : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                {
                    if (weapon.name == "Dart1") weapon.ejectX = 9;
                    if (weapon.name == "Dart2") weapon.ejectX = 3;
                    if (weapon.name == "Dart3") weapon.ejectX = -3;
                    if (weapon.name == "Dart4") weapon.ejectX = -9;
                }
        ...
        public class Dogfighter : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                var effect = Game.instance.model.GetTower(TowerType.BombShooter).GetWeapon().projectile
                    .GetBehavior<CreateEffectOnContactModel>().Duplicate();
                bomb.name = "SplodeyDart";
                bomb.projectile.GetDamageModel().damage += 2;

                var gatling = Game.instance.model.GetTower(TowerType.HeliPilot, 4).GetAttackModel().weapons[2]
                    .Duplicate();
                ...
                wpn.weapons[0].projectile.AddBehavior(effect);
                wpn.weapons[0].projectile.pierce = 1;
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnContactModel("Crackshot", dart,
                    new ArcEmissionModel("ArcEmissionModel_", 4, 0, 35, null, true, false), true, false, false));
                wpn.weapons[0].projectile.GetDamageModel().damage += 1;
        ...
        public class Railgun : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                var railgun = Game.instance.model.GetTower(TowerType.HeliPilot, 4).GetAttackModel().weapons[2]
                    .Duplicate();
                ...
                railgun.rate = Game.instance.model.GetTower(TowerType.HeliPilot, 2).GetAttackModel().weapons[0].rate *
                               3f;
                ...
                wpn.weapons[0].projectile.display = Game.instance.model.GetTowerFromId("DartlingGunner-300")
                    .GetAttackModel().weapons[0].projectile.display;
        ...
        public class CarpetBomb : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExhaustFractionModel("CarpetBomb-1", bomb,
                    new ArcEmissionModel("", 4, 0, 360, null, true, false), mortar.fraction, mortar.durationfraction,
                    true, false, true));
        ...
        public class Volley : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
                wpn.weapons[0].projectile.AddBehavior(new WindModel("WindModel_", 6, 12, 100, false, null, 0, null));
                wpn.weapons[0].projectile.GetDamageModel().damage += 1;
        ...
        public class SpectralClaws : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                shard.AddBehavior(new TrackTargetModel("", 999, seeking.trackNewTargets, true, seeking.maxSeekAngle,
                    seeking.ignoreSeekAngle, seeking.turnRate * 6, seeking.overrideRotation,
                    seeking.useLifetimeAsDistance));
                ...
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExpireModel("SpectralShards", shard,
                    new ArcEmissionModel("", 3, 0, 30, null, false, false), false));
                wpn.range = tower.towerModel.range;
                var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
                towerModel.AddBehavior(wpn);
                tower.UpdateRootModel(towerModel);
        ...
        public class DeepDruid : WeaponTemplate
        {
            ...
            {
                var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
                var wpn = Game.instance.model.GetTower(TowerType.BeastHandler, 3).GetBehavior<BeastHandlerLeashModel>()
                    .towerModel.GetAttackModel().Duplicate();
                wpn.AddBehavior(new TargetStrongModel("targetstrong", false, false));
                wpn.AddBehavior(new TargetCloseModel("targetclose", false, false));
                wpn.AddBehavior(new TargetFirstModel("targetfirst", false, false));
                wpn.AddBehavior(new TargetLastModel("targetlast", false, false));
        ...
        public class HealthierBananas : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                var lives = Game.instance.model.GetTower(TowerType.BananaFarm, 0, 0, 5)
                    .GetBehavior<BonusLivesPerRoundModel>().Duplicate();
        ...
        public class ShieldGenerator : WeaponTemplate
        {
            ...
            public override void EditTower(Tower tower)
            {
                ...
                wpn.weapons[0].projectile.AddBehavior(new WindModel("WindModel_", 0, 10, 50, false, null, 0, null));
        ...
        public class PrototypeSentries : WeaponTemplate
        {
            ...
            {
                var druid = Game.instance.model.GetTower(TowerType.Druid, 2);
                var lightning = druid.GetAttackModel().weapons.First(w => w.name == "WeaponModel_Lightning")
                    .Duplicate();
        ...
        public class TruckNotRotorDisplay : ModDisplay
        {
            public override PrefabReference BaseDisplayReference => Game.instance.model
                .GetTower(TowerType.HeliPilot, 0, 4).GetBehavior<AirUnitModel>().display;
...
namespace Monkeys
{
    public class Officer : ModTower
    {
        ...
        public override void ModifyBaseTowerModel(TowerModel towerModel)
        {
            ...
            var Pops = Game.instance.model.GetTowerFromId("Sentry").GetBehavior<CreditPopsToParentTowerModel>()
                .Duplicate();
