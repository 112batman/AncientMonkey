...
{
    public static List<string> LegendaryWpn = new();
    public static List<string> LegendaryImg = new();
    public static List<Sprite> LegendaryCustomImg = new();
    ...
    public class SpiritOfTheForest : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.range = tower.towerModel.range;
            var vines = Game.instance.model.GetTowerFromId("Druid-250").GetBehavior<SpiritOfTheForestModel>()
                .Duplicate();
            var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
            towerModel.AddBehavior(wpn);
    ...
    public class SkyShredder : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var phoenix = Game.instance.model.GetTowerFromId("WizardMonkey-050").GetBehavior<TowerCreateTowerModel>()
                .Duplicate();
            ...
            var wpn2 = Game.instance.model.GetTowerFromId("MonkeyAce-520").GetBehaviors<AttackAirUnitModel>()[1]
                .Duplicate();
            var wpn3 = Game.instance.model.GetTowerFromId("MonkeyAce-520").GetBehaviors<AttackAirUnitModel>()[2]
                .Duplicate();
            var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
            ace.AddBehavior(wpn);
    ...
    public class PlasmaTank : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var seeking = Game.instance.model.GetTowerFromId("WizardMonkey-500").GetWeapon().projectile
                .GetBehavior<TrackTargetModel>().Duplicate();
            ...
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Ceramic", 1, 10, false, false)
                { name = "CeramicModifier_" });
            wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.SuperMonkey, 2).GetAttackModel()
                .weapons[0].projectile.display;
            wpn.range = tower.towerModel.range;

            var missileWeapon = Game.instance.model.GetTower(TowerType.BombShooter, 1, 2).GetAttackModel().Duplicate();
            missileWeapon.weapons[0].rate =
                Game.instance.model.GetTower(TowerType.DartMonkey).GetAttackModel().weapons[0].rate;
            missileWeapon.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.DartlingGunner, 0, 3)
            ...
            missileWeapon.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile
                .GetDescendants<FilterInvisibleModel>().ForEach(model => model.isActive = false);
            ...
            missile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 1, 56, false, false)
                { name = "MoabModifier_" });
    ...
    public class BladeGod : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var travel = Game.instance.model.GetTower(TowerType.DartMonkey).GetWeapon().projectile
                .GetBehavior<TravelStraitModel>().Duplicate();
            var seeking = Game.instance.model.GetTower(TowerType.NinjaMonkey, 0, 0, 1).GetWeapon().projectile
                .GetBehavior<TrackTargetModel>().Duplicate();
            var bleed = Game.instance.model.GetTowerFromId("Sauda 9").GetAttackModel().weapons[0].projectile
            ...
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Camo", 1, 1, false, false)
                { name = "CamoModifier_" });
            ...
            wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
            wpn.weapons[0].projectile.GetBehavior<AddBehaviorToBloonModel>().GetBehavior<DamageOverTimeModel>()
                .interval /= 2f;
            wpn.weapons[0].projectile.GetBehavior<AddBehaviorToBloonModel>().GetBehavior<DamageOverTimeModel>()
                .damage += 7;
            ...
            wpn.weapons[0].projectile.AddBehavior(new AddBonusDamagePerHitToBloonModel("aaa", "bleed_Bonus_Damage", 8f,
                3, 15, true, false, false, "bleed"));
            wpn.range = tower.towerModel.range;
            var towerModel = tower.rootModel.Duplicate().Cast<TowerModel>();
            towerModel.AddBehavior(wpn);
            tower.UpdateRootModel(towerModel);
    ...
    public class SuperNova : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            var techTerror = super.GetDescendants<AttackModel>().ToArray()
                .First(a => a.name == "AttackModel_TechTerror_").Duplicate();
            var fire = Game.instance.model.GetTowerFromId("MortarMonkey-002").Duplicate().GetBehavior<AttackModel>()
                .weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile
                .GetBehavior<AddBehaviorToBloonModel>().Duplicate();
            ...
            charge.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 1, 60, false, false)
                { name = "MoabModifier_" });
            charge.AddBehavior(fire);
            var chargeBehavior = new CreateProjectileOnContactModel("", charge,
                    new ArcEmissionModel("ArcEmissionModel_", 1, 0, 0, null, false, false), true, false, false)
                { name = "PlasmaBlast_" };
            ...
            var lightningVisualBehavior = new CreateProjectileOnContactModel("", lightningVisual,
                    new ArcEmissionModel("ArcEmissionModel_", 1, 0, 0, null, false, false), true, false, false)
                { name = "PlasmaVisual_" };

            var druid = Game.instance.model.GetTower(TowerType.Druid, 2);
            var lightningBolt = druid.GetAttackModel().weapons.First(w => w.name == "WeaponModel_Lightning")
                .Duplicate();
            ...
            var lightningBehavior = new CreateProjectileOnContactModel("", lightning,
                    new ArcEmissionModel("ArcEmissionModel_", 3, 0, 0, null, false, false), true, false, false)
                { name = "Lightning_" };
            ...
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.collisionPasses =
                new[] { 0, -1 };
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.hasDamageModifiers =
                true;
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.AddBehavior(
                new DamageModifierForTagModel("aaa", "Ceramic", 1, 9, false, false) { name = "CeramicModifier_" });
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.AddBehavior(
                new DamageModifierForTagModel("aaa", "Fortified", 1, 9, false, false) { name = "FortifiedModifier_" });
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.AddBehavior(
                new DamageModifierForTagModel("aaa", "Moabs", 1, 60, false, false) { name = "MoabModifier_" });
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.GetDamageModel()
                .damage += 34;
    ...
    public class Fireworks : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var effect = Game.instance.model.GetTower(TowerType.MortarMonkey).GetAttackModel().weapons[0].projectile
                .GetBehavior<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.CreateEffectOnExpireModel>()
                .Duplicate();
            var sound = Game.instance.model.GetTower(TowerType.MortarMonkey).GetAttackModel().weapons[0].projectile
                .GetBehavior<CreateSoundOnProjectileExhaustModel>().Duplicate();
            var explosion = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0].projectile
                .GetBehavior<CreateProjectileOnContactModel>().projectile.Duplicate();
            var bombEffect = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0].projectile
                .GetBehavior<CreateEffectOnContactModel>().effectModel.Duplicate();
            ...
            wpn.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel()
                .weapons[0].projectile.display;
            ...
            wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExpireModel("Explosion", explosion,
                new ArcEmissionModel("FragmentEmmision_", 1, 0, 0, null, true, false), false));
            ...
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExpireModel("Firework", firework,
                new ArcEmissionModel("FragmentEmmision_", 8, 0, 360, null, true, false), false));
    ...
    public class Bloonzooka : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var rocket = Game.instance.model.GetTower(TowerType.BombShooter, 0, 2).GetAttackModel().weapons[0]
                .Duplicate();
            var homing = Game.instance.model.GetTowerFromId("WizardMonkey-500").GetWeapon().projectile
                .GetBehavior<TrackTargetModel>().Duplicate();
            ...
            rocket.rate = Game.instance.model.GetTower(TowerType.SniperMonkey, 0, 0, 2).GetAttackModel().weapons[0]
                .rate;
            rocket.projectile.GetBehavior<TravelStraitModel>().Lifespan *= 3;
            rocket.projectile.GetBehavior<TravelStraitModel>().Speed /= 1.45f;

            var shrapnel = Game.instance.model.GetTower(TowerType.TackShooter).GetAttackModel().weapons[0].projectile
                .Duplicate();
            ...
            var fragmentModel = new CreateProjectileOnContactModel("aaa", shrapnel,
                    new ArcEmissionModel("ArcEmissionModel_", 16, 0, 360, null, true, false), true, false, false)
                { name = "RifleShrapnel_" };
    ...
    public class NauticDestroyer : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            {
                if (weapon.name == "Dart1") weapon.ejectX = 10;
                if (weapon.name == "Dart2") weapon.ejectX = 5;
                if (weapon.name == "Dart3") weapon.ejectX = 0;
                if (weapon.name == "Dart4") weapon.ejectX = -5;
                if (weapon.name == "Dart5") weapon.ejectX = -10;
            }
            ...
            torpedo.weapons[0].projectile.display = Game.instance.model.GetTower(TowerType.BombShooter, 0, 2)
                .GetWeapon().projectile.display;
            ...
            torpedo.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.GetDamageModel()
                .damage += 14;
            torpedo.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.GetDamageModel()
                .immuneBloonProperties = BloonProperties.None;
            torpedo.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.hasDamageModifiers =
                true;
            torpedo.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.AddBehavior(
                new DamageModifierForTagModel("aaa", "Moabs", 1, 24, false, false) { name = "MoabModifier_" });
    ...
    public class SidewinderAce : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            plane.GetAttackModel(1).weapons[0].rate = Game.instance.model.GetTower(TowerType.MonkeyAce, 2)
                .GetAttackModel().weapons[0].rate;
            ...
            plane.GetAttackModel(0).weapons[0].projectile.AddBehavior(
                new DamageModifierForTagModel("aaa", "Moabs", 3, 2, false, false) { name = "MoabModifier_" });
            ...
            gatling.projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 4, 0, false, false)
                { name = "MoabModifier_" });
    ...
    public class RollingThunder : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var bomb = Game.instance.model.GetTower(TowerType.DartMonkey).GetAttackModel().weapons[0].projectile
                .Duplicate();
            var mortar = Game.instance.model.GetTower(TowerType.MortarMonkey).GetAttackModel().weapons[0].projectile
            ...
            var sound = Game.instance.model.GetTower(TowerType.MortarMonkey).GetAttackModel().weapons[0].projectile
                .GetBehavior<CreateSoundOnProjectileExhaustModel>().Duplicate();
            var explosion = Game.instance.model.GetTower(TowerType.BombShooter, 2).GetAttackModel().weapons[0]
                .projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.Duplicate();
            var bombEffect = Game.instance.model.GetTower(TowerType.BombShooter, 2).GetAttackModel().weapons[0]
                .projectile.GetBehavior<CreateEffectOnContactModel>().effectModel.Duplicate();
            var thunderExplosion = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0]
                .projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.Duplicate();
            var thunderEffect = Game.instance.model.GetTower(TowerType.BombShooter).GetAttackModel().weapons[0]
                .projectile.GetBehavior<CreateEffectOnContactModel>().effectModel.Duplicate();
            ...
            bomb.display = Game.instance.model.GetTower(TowerType.DartlingGunner, 5).GetAttackModel().weapons[0]
                .projectile.display;

            var thunderBomb = bomb.Duplicate();

            bomb.AddBehavior(new CreateProjectileOnExpireModel("ThunderExplosion", thunderBomb,
                new ArcEmissionModel("", 5, 0, 360, null, true, false), false));
            bomb.AddBehavior(new CreateProjectileOnExpireModel("ExpireExplosion", explosion,
                new ArcEmissionModel("", 1, 0, 0, null, true, false), false));
            thunderBomb.AddBehavior(new CreateProjectileOnExpireModel("ThunderBombs", explosion,
                new ArcEmissionModel("", 1, 0, 0, null, true, false), false));
            ...
            wpn.AddBehavior(new TargetFirstModel("targetfirst", false, false));
            wpn.AddBehavior(new TargetLastModel("targetlast", false, false));
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.GetDamageModel()
                .damage += 6;
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExhaustFractionModel("CarpetBomb-1", bomb,
                new ArcEmissionModel("", 8, 0, 360, null, true, false), mortar.fraction, mortar.durationfraction, true,
                false, true));
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExhaustFractionModel("CarpetBomb-2", bomb2,
                new ArcEmissionModel("", 8, 0, 360, null, true, false), mortar.fraction, mortar.durationfraction, true,
                false, true));
            wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExhaustFractionModel("CarpetBomb-3", bomb3,
                new ArcEmissionModel("", 8, 0, 360, null, true, false), mortar.fraction, mortar.durationfraction, true,
                false, true));
            towerModel.AddBehavior(wpn);
            tower.UpdateRootModel(towerModel);
    ...
    public class DemonBlade : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.weapons[0].rate =
                Game.instance.model.GetTowerFromId("NinjaMonkey-200").GetAttackModel().weapons[0].rate * 1.3f;
            wpn.weapons[0].projectile.ApplyDisplay<DemonBladeProj>();
            wpn.weapons[0].projectile.hasDamageModifiers = true;
            wpn.weapons[0].projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 1, 125, false, false)
                { name = "MoabModifier_" });
            wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = BloonProperties.None;

            var blades = Game.instance.model.GetTower(TowerType.DartMonkey, 0, 0, 2).GetAttackModel().weapons[0]
                .Duplicate();
            ...
            blades.projectile.AddBehavior(new DamageModifierForTagModel("aaa", "Moabs", 1, 32, false, false)
                { name = "MoabModifier_" });
    ...
    public class SuperAcid : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.GetDescendants<FilterInvisibleModel>().ForEach(model => model.isActive = false);
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.AddBehavior(
                new FreezeModel("FreezeModel_", 0, 1f, "AcidFreeze", 1, "Ice", true,
                    new GrowBlockModel("GrowBlockModel_"), null, 0, false, false));
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.collisionPasses =
                new[] { 0, -1 };
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.GetDamageModel()
                .damage += 1;
            ...
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.GetDamageModel()
                .damage += 1;
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile
                .GetBehavior<AddBehaviorToBloonModel>().GetBehavior<DamageOverTimeModel>().damage += 9;
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile
                .GetBehavior<AddBehaviorToBloonModel>().GetBehavior<DamageOverTimeModel>().interval -= 1f;
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile
                .hasDamageModifiers = true;
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.AddBehavior(
                new DamageModifierForTagModel("aaa", "Moabs", 1, 18, false, false) { name = "MoabModifier_" });
            wpn.weapons[0].projectile.GetBehavior<CreateProjectileOnExhaustFractionModel>().projectile.AddBehavior(
                new AddBonusDamagePerHitToBloonModel("aaa", "Acid_Bonus_Damage", 4f, 5, 999, true, false, false,
                    "bleed"));
            wpn.range = tower.towerModel.range;
            towerModel.AddBehavior(wpn);
            tower.UpdateRootModel(towerModel);
    ...
    public class OmegaBeacon : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            ...
            wpn.weapons[0].projectile.pierce += 4;
            wpn.weapons[0].projectile.AddBehavior(new FreezeModel("FreezeModel_", 0, 1f, "BeaconStun", 999, "Stun",
                true, new GrowBlockModel("GrowBlockModel_"), null, 0.5f, true, true));
    ...
    public class Overcharge : WeaponTemplate
    {
        ...
        public override void EditTower(Tower tower)
        {
            var ballLightning = Game.instance.model.GetTower(TowerType.Druid, 4).GetAttackModel().weapons[1]
                .Duplicate();
            ...
            droneAttackModel.weapons[0].projectile.display = Game.instance.model.GetTowerFromId("DartlingGunner-300")
                .GetAttackModel().weapons[0].projectile.display;
