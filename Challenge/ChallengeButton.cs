...
public static class ChallengeButton
{
    ...
    public static void CreatePanel(GameObject screen)
    {
        ...
        image = panel.AddButton(
            new Info("ChallengeButton", -4390, 500, 420, 420, new Vector2(1, 0), new Vector2(0.5f, 0)),
            VanillaSprites.ChallengesIcon, new Action(OpenEditorPanel));
    ...
    private static void Init()
    {
        ...
        if (ModSavePanel == null) CreatePanel(screen.gameObject);
    }
    ...
    public static void Hide()
    {
        var screen = CommonForegroundScreen.instance.transform;
        var ModSavePanel = screen.FindChild("ChallengeButton");
        if (ModSavePanel != null) HideButton();
    }
}
...
internal static class MenuManager_OpenMenu
{
    ...
    {
        if (menuName == "MapSelectScreen") ChallengeButton.Show();
    }
}
